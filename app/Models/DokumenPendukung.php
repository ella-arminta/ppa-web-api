...
class DokumenPendukung extends Model
{
    ...
    public static function validationRules()
    {
        return [
            ...
            'dokumen_pendukung.*.*' => 'nullable|file|mimes:pdf,doc,docx,xls,xlsx,jpeg,png,jpg,gif,svg|max:10240',
            'foto_klien' => 'nullable|array',
            'foto_klien.*' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:10240',
            'foto_tempat_tinggal' => 'nullable|array',
            'foto_tempat_tinggal.*' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:10240',
            'foto_pendampingan_awal' => 'nullable|array',
            'foto_pendampingan_awal.*' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:10240',
            'foto_pendampingan_lanjutan' => 'nullable|array',
            'foto_pendampingan_lanjutan.*' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:10240',
            'foto_pendampingan_monitoring' => 'nullable|array',
            'foto_pendampingan_monitoring.*' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:10240',
            'foto_kk' => 'nullable|array',
            'foto_kk.*' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg|max:10240',
            'dokumen_pendukung' => 'nullable|array',
            'dokumen_pendukung.*' => 'nullable|file|mimes:pdf,doc,docx,xls,xlsx,jpeg,png,jpg,gif,svg|max:10240',
        ];
    }
