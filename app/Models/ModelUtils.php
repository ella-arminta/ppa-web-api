...
class ModelUtils
{
    ...
    public static function addAttributeWithoutToken($request)
    {
        ...
        return [
            ...
            'updated_by_situasi_keluarga' => $request->updated_by_situasi_keluargas ? new UserResource($request->updated_by_situasi_keluargas) : null,
            'updated_by_kronologi' => $request->updated_by_kronologis ? new UserResource($request->updated_by_kronologis) : null,
            'updated_by_kondisi_klien' => $request->updated_by_kondisi_kliens ? new UserResource($request->updated_by_kondisi_kliens) : null,
            'updated_by_langkah_telah_dilakukan' => $request->updated_by_langkah_telah_dilakukans  ? new UserResource($request->updated_by_langkah_telah_dilakukans) : null,
